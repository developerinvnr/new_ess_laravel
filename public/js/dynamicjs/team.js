                  ...
                  if (response.length > 0) {
                      ...
                      $.each(response, function (index, query) {
                        ...
                        var showActionButton = [
                            ...
                            query.Level_2ID, query.Level_2QFwdEmpId, query.Level_2QFwdEmpId2, query.Level_2QFwdEmpId3,
                            query.Level_3ID, query.Level_3QFwdEmpId, query.Level_3QFwdEmpId2, query.Level_3QFwdEmpId3
