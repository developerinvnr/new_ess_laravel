<div class="row">
    <div class="col-12">
        <div class="card mb-1" style="width:auto;padding: 3px;min-width: 105px;text-align: center;float: left;background-color: #a9cbcd;">
            <a href="{{ route('manage/hroperations_master') }}">
                <div class="card-body d-flex align-items-center p-0 {{request()->routeIs('manage/hroperations_master') ? 'bg-success-subtle' : ''}}">
        ...
        <div class="card mb-1" style="width:auto;padding: 3px;margin-left:10px;min-width: 105px;text-align: center;float: left;">
            <a href="{{ route('manage/hroperationsworkflow_master') }}">
                <div class="card-body d-flex align-items-center p-0 {{request()->routeIs('manage/hroperationsworkflow_master') ? 'bg-success-subtle' : ''}}">
                    <div class="avatar-sm">
                        <div class="avatar-title border bg-success-subtle border-success border-opacity-25 rounded-2 fs-17">
