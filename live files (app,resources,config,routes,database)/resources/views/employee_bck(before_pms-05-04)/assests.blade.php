                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->vehicle_image != '')
                                                                                             @if(str_ends_with($request->vehicle_image, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->vehicle_image) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->vehicle_image) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->rc_file != '')
                                                                                             @if(str_ends_with($request->rc_file, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->rc_file) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->rc_file) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->insurance != '')
                                                                                             @if(str_ends_with($request->insurance, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->insurance) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->insurance) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->four_vehicle_image != '')
                                                                                             @if(str_ends_with($request->four_vehicle_image, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_vehicle_image) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_vehicle_image) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->four_rc_file != '')
                                                                                             @if(str_ends_with($request->four_rc_file, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_rc_file) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_rc_file) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
                                                                                       ...
                                                                                       <td>
                                                                                          @if($request->four_insurance != '')
                                                                                             @if(str_ends_with($request->four_insurance, '.pdf'))
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#pdfModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_insurance) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @else
                                                                                                   <a href="#" data-bs-toggle="modal" data-bs-target="#fileModal" data-file-url="{{ url('Employee/VehcileInfo/' . $request->four_insurance) }}" data-file-type="bill">
                                                                                                      <i class="fas fa-eye me-2"></i>
                                                                                                   </a>
                                                                                             @endif
                                                                                          @else
      ...
      <div class="modal-dialog modal-lg">
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <!-- Vehicle Brand -->
                  <div class="mb-3">
                     <label for="modal_vehicle_brand" class="form-label">Vehicle Brand</label>
                     <input type="text" class="form-control" id="modal_vehicle_brand" name="vehicle_brand">
                  </div>

                  <!-- Model Name -->
                  <div class="mb-3">
                     <label for="modal_model_name" class="form-label">Model Name</label>
                     <input type="text" class="form-control" id="modal_model_name" name="model_name">
                  </div>

                  <!-- Model Number -->
                  <div class="mb-3">
                     <label for="modal_model_no" class="form-label">Model No</label>
                     <input type="text" class="form-control" id="modal_model_no" name="model_no">
                  </div>

                  <!-- Dealer Name -->
                  <div class="mb-3">
                     <label for="modal_dealer_name" class="form-label">Dealer Name</label>
                     <input type="text" class="form-control" id="modal_dealer_name" name="dealer_name">
                  </div>

                  <!-- Dealer Contact -->
                  <div class="mb-3">
                     <label for="modal_dealer_contact" class="form-label">Dealer Contact</label>
                     <input type="text" class="form-control" id="modal_dealer_contact" name="dealer_contact" pattern="^\d{10}$|^\d{12}$">
                  </div>

                  <!-- Purchase Date -->
                  <div class="mb-3">
                     <label for="modal_purchase_date" class="form-label">Purchase Date</label>
                     <input type="date" class="form-control" id="modal_purchase_date" name="purchase_date">
                  </div>
                  ...
                  <div class="mb-3">
                     ...
                     <input type="text" class="form-control" id="modal_registration_no" name="registration_number">
                  </div>

                  <!-- Registration Date -->
                  <div class="mb-3">
                     <label for="modal_registration_date" class="form-label">Registration Date</label>
                     <input type="date" class="form-control" id="modal_registration_date" name="registration_date">
                  </div>

                  <!-- Bill Number -->
                  <div class="mb-3">
                     <label for="modal_bill_no" class="form-label">Bill Number</label>
                     <input type="text" class="form-control" id="modal_bill_no" name="bill_number">
                  </div>

                  <!-- Invoice -->
                  <!-- <div class="mb-3">
                     <label for="modal_invoice" class="form-label">Invoice</label>
                     <input type="text" class="form-control" id="modal_invoice" name="invoice">
                  </div> -->
                  ...
                  <!-- Vehicle Image -->
                  <div class="mb-3">
                     <label for="modal_vehicle_image" class="form-label">Vehicle Image</label>
                  ...
                  <!-- RC File -->
                  <div class="mb-3">
                     <label for="modal_rc_file" class="form-label">RC copy</label>
                     <input type="file" class="form-control" id="modal_rc_file" name="rc_file">
                  </div>

                  <!-- Insurance -->
                  <div class="mb-3">
                     <label for="modal_insurance" class="form-label">Insurance copy</label>
                  ...
                  <div id="four-wheeler-fields" style="display: none;">
                           <!-- Four Vehicle Brand -->
                        <div class="mb-3">
                           <label for="modal_four_brand" class="form-label">Brand</label>
                           <input type="text" class="form-control" id="modal_four_brand" name="four_brand">
                        </div>

                        <!-- Model Name -->
                        <div class="mb-3">
                           <label for="modal_four_model_name" class="form-label">Model Name</label>
                           <input type="text" class="form-control" id="modal_four_model_name" name="four_model_name">
                        </div>

                        <!-- Model Number -->
                        <div class="mb-3">
                           <label for="modal_four_model_no" class="form-label">Model No</label>
                           <input type="text" class="form-control" id="modal_four_model_no" name="four_model_no">
                        </div>

                        <!-- Dealer Name -->
                        <div class="mb-3">
                           <label for="modal_four_dealer_name" class="form-label">Dealer Name</label>
                           <input type="text" class="form-control" id="modal_four_dealer_name" name="four_dealer_name">
                        </div>

                        <!-- Dealer Contact -->
                        <div class="mb-3">
                           <label for="modal_four_dealer_contact" class="form-label">Dealer Contact</label>
                           <input type="text" class="form-control" id="modal_four_dealer_contact" name="four_dealer_contact" pattern="^\d{10}$|^\d{12}$">
                        </div>

                        <!-- Purchase Date -->
                        <div class="mb-3">
                           <label for="modal_four_purchase_date" class="form-label">Purchase Date</label>
                           <input type="date" class="form-control" id="modal_four_purchase_date" name="four_purchase_date">
                        </div>

                        <!-- Price -->
                        <div class="mb-3">
                           <label for="modal_four_price" class="form-label">Price</label>
                           <input type="number" class="form-control" id="modal_four_price" name="four_price">
                        </div>

                        <!-- Registration Number -->
                        <div class="mb-3">
                           <label for="modal_four_registration_no" class="form-label">Registration No</label>
                           <input type="text" class="form-control" id="modal_four_registration_no" name="four_registration_number">
                        </div>

                        <!-- Registration Date -->
                        <div class="mb-3">
                           <label for="modal_four_registration_date" class="form-label">Registration Date</label>
                           <input type="date" class="form-control" id="modal_four_registration_date" name="four_registration_date">
                        </div>

                        <!-- Bill Number -->
                        <div class="mb-3">
                           <label for="modal_four_bill_no" class="form-label">Bill Number</label>
                           <input type="text" class="form-control" id="modal_four_bill_no" name="four_bill_number">
                        </div>

                        <!-- Invoice -->
                        <!-- <div class="mb-3">
                           <label for="modal_four_invoice" class="form-label">Invoice</label>
                           <input type="text" class="form-control" id="modal_four_invoice" name="four_invoice">
                        </div> -->

                        <!-- Fuel Type -->
                        <div class="mb-3">
                           <label for="modal_four_fuel_type" class="form-label">Fuel Type</label>
                        ...
                        <!-- Four Ownership -->
                        <div class="mb-3">
                           <label for="modal_four_ownership" class="form-label">Ownership</label>
                        ...
                        <!-- Vehicle Image -->
                        <div class="mb-3">
                           <label for="modal_four_vehicle_image" class="form-label">Vehicle Image</label>
                           <input type="file" class="form-control" id="modal_four_vehicle_image" name="four_vehicle_image">
                        </div>

                        <!-- RC File -->
                        <div class="mb-3">
                           <label for="modal_four_rc_file" class="form-label">RC copy</label>
                           <input type="file" class="form-control" id="modal_four_rc_file" name="four_rc_file">
                        </div>

                        <!-- Insurance -->
                        <div class="mb-3">
                           <label for="modal_four_insurance" class="form-label">Insurance copy</label>
                  ...
                  <div class="col-md-12" id="ITFeild" style="display: none">
                     <div class="query-req-section">
                        <div class="float-start w-100 pb-2 mb-2" style="border-bottom:1px solid #ddd;">
                           ...
                           <span class="float-end"><b>Status: <span id="ITApprovalStatus">Pending</span></b></span>
                        </div>
                        <div class="mb-2">
                  ...
                  <div class="col-md-12" id="AccPayFeild" style="display: none">
                     <div class="query-req-section">
                        <div class="float-start w-100 pb-2 mb-2" style="border-bottom:1px solid #ddd;">
                           ...
                           <span class="float-end"><b>Status: <span id="AccPayStatus">Pending</span></b></span>
                        </div>
                        <div class="mb-2">
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                  ...
                  // Update the display with icons or "Not Available" text
                  $('#asstBillCopy').html(billCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-file-pdf"></i>').attr('href', billCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : billCopyUrl);
                  $('#asstAssetsCopy').html(assetsCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-file"></i>').attr('href', assetsCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : assetsCopyUrl);
                  $('#asstVehiclePhoto').html(vehiclePhotoUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-image"></i>').attr('href', vehiclePhotoUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : vehiclePhotoUrl);
                  $('#asstRCCopy').html(rcCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-file-alt"></i>').attr('href', rcCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : rcCopyUrl);
                  $('#asstDLCopy').html(dLCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-id-card"></i>').attr('href', dLCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : dLCopyUrl);
                  $('#asstInsuranceCopy').html(insuranceCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-file-invoice"></i>').attr('href', insuranceCopyUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : insuranceCopyUrl);
                  $('#asstOdometerReading').html(odometerReadingUrl.trim() === 'Employee/AssetReqUploadFile/' ? 'Not Available' : '<i class="fas fa-tachometer-alt"></i>').attr('href', odometerReadingUrl.trim() === 'Employee/AssetReqUploadFile/' ? '#' : odometerReadingUrl);
