		...
		<div class="page-wrapper">
			<div class="main-content">
				...
				<div class="row">
													...
													<tr>
														...
														<td>
															<button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
																...
																@if (($loggedInEmployeeID == $request->HodId || $loggedInEmployeeID == $request->ReportingId) && $request->HODApprovalStatus == 1)
																	disabled
																@elseif ($loggedInEmployeeID == $request->ITId && $request->ITApprovalStatus == 1)
																	disabled
																@elseif ($loggedInEmployeeID == $request->AccId && $request->AccPayStatus == 1)
																	disabled
																@endif>
																Action
															</button>
						...
						<div class="col-xl-6 col-lg-6 col-m	d-6 col-sm-12">
