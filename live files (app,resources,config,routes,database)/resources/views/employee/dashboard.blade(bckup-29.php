                    ...
                    @php
                        ...
                        @if (in_array($companyId, [1, 3]))
                           <div class="card chart-card">
                                ...
                                <div class="dropdown">
                                    <a class="dropdown-toggle" href="#" role="button" id="manualDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="font-size:14px;" title="View Help Manual">
                                        <i class="fa fa-question-circle" aria-hidden="true"></i> <b>Manual</b>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="manualDropdown">
                                        <li>
                                            <a class="dropdown-item" href="{{ asset('helpfiles/helpfile.pdf') }}" target="_blank" style="font-size: 13px;color: black;">
                                                <i class="fa fa-question-circle" aria-hidden="true"></i>English Manual
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ asset('helpfiles/helpfile_hindi.pdf') }}" target="_blank" style="font-size: 13px;color: black;">
                                                <i class="fa fa-question-circle" aria-hidden="true"></i> Hindi Manual
                                            </a>
                                        </li>
                                    </ul>
                                </div>
