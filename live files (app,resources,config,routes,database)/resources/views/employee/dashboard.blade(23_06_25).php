                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                @php
                                    ...
                                    <li>
                                        ...
                                        <!-- Download link -->
                                          <a style="float: right;" 
                                            href="{{ $hasConfirmed ? route('ledger.download', [
                                                'companyId' => auth()->user()->CompanyId,
                                                'year' => '2024-25',
                                                'empCode' => $empCode,
                                        ...
                                        <!-- View link with modal trigger -->
                                        <a style="float: right;" href="#">
                                            <i class="fas fa-eye mr-2" data-bs-toggle="modal" data-bs-target="#ledgerViewModal" style="cursor: pointer;"></i> | 
                                        </a>
                                        @else
                                        <a style="float: right;" href="#">
