...
//dd($expCompanies);
   ...
   $kids->transform(function ($kid) {
    ...
    return [
       ...
       // dd($employees);
    return view('employee.dashboard',compact('sqlConf','showLetter','missingDates','attRequests','isConfirmationDue','employeeQueryData','leaveRequests','display_ojas','query_department_list','departments_sub','employees','showWarmWelcome')); // Adjust the view name as needed
    }
