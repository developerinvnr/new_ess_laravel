...
{
    protected $type, $employeeId, $pmsYId, $department, $grade, $region, $hod, $rev, $zone, $bu;

    public function __construct($type, $employeeId, $pmsYId, $department = null, $grade = null, $region = null, $hod = null, $rev = null,$zone = null, $bu = null )
    {
