...
<body class="mini-sidebar">
                            ...
                            <div class="tab-pane fade show active " id="accountTab" role="tabpanel">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="{{ route('export.approvedEmployeesacc') }}" style="font-size: 20px; color:black;float:inline-end; ">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-bordered" id="accttable">
                                        ...
                                        <tbody>
                                            ...
                                            $accstatus = $data->Acc_NOC;
                                            @endphp
                                            @if($matchesStatus)
                                            <tr data-status="{{ $accstatus }}">
                                                <td>{{ $index + 1 }}.</td>
                                                <td>{{ $data->EmpCode }}</td>
                        ...
                        <div class="tab-pane fade" id="logistics" role="tabpanel" aria-labelledby="logistics-tab">
                            <form id="logisticsnocform">
                                ...
                                <h5 style="border-bottom: 1px solid #ddd; margin-bottom: 10px;">
                                    ...
                                    </div> <a class="effect-btn btn btn-success squer-btn sm-btn" id="add-more">
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (buttonId === 'save-draft-btn-log') {
                            var empSepId = $('input[name="EmpSepId"]').val();
                            var employeeid = $('input[name="EmployeeID"]').val();
                            refreshModalDatalog(empSepId, employeeid); // Refresh the modal data after submission
    ...
    `;
        ...
        // Function to refresh the modal content
        function refreshModalDatalog(empSepId, employeeid) {
                    ...
                    .then(data => {
                        ...
                        if (data.success) { // Use 'data' instead of 'response'
                            ...
                            if (buttonId === 'save-draft-btn-log') {
                                var empSepId = $('input[name="EmpSepId"]').val();
                                var employeeid = $('input[name="EmployeeID"]').val();
                                refreshModalDataIt(empSepId, employeeid); // Refresh the modal data after submission
                            } else if (buttonId === 'final-submit-btn-log') {
                                // If the Final Submit button was clicked, reload the page
                                setTimeout(function() {
                                    location.reload(); // Reload the page after a short delay to match the toast timeout
        ...
        // Function to refresh the modal content
        function refreshModalDataIt(empSepId, employeeid) {
        ...
        document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                let groupName = this.name; // Get the name of the current checkbox group
                if (this.checked) {
