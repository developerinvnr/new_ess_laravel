...
<body class="mini-sidebar">
                           ...
                           <table class="table table-bordered" id="accttable">
                              <thead style="background-color:#cfdce1;">
                                 <tr>
                                    ...
                                    <th rowspan="2">Resignation Approved</th>
                                    <th colspan="5">Clearance Status</th>
                                    <!-- Span 5 columns for Clearance Status -->
                                    <th rowspan="2">Clearance form</th>
                                 </tr>
                                 <tr>
   ...
   <script>
    ...
    if (!defaultFilterValue) {
        ...
        var defaultText = defaultFilterValue === 'Y' ? 'Approved' : defaultFilterValue === 'N' ? 'Pending' : '';
...
$(document).ready(function () {
    var defaultFilter = '{{ request()->get('acct_status', '') }}'; 
    initializeTable('#accttable', '#acctFilter', 12, defaultFilter);
});
