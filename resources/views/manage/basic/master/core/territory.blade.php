        ...
        <table id="myTable" class="table table-bordered align-middle" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Territory Code</th>
            ...
            <tbody>
                @foreach ($territory_list as $territory)
                    <tr>
                        ...
                        <td class="text-center">{{ $territory->territory_code }}</td>
                        <td class="text-center">{{ $territory->numeric_code }}</td>
                        <td class="text-center">
                            <!-- Effective Date -->
                            @if ($territory->effective_date)
                                {{ date('d-m-Y', strtotime($territory->effective_date)) }}
                            @else
                            N/A
                            @endif
                        </td>
                        <td class="text-center">
                            @if ($territory->is_active == 1)
                                Yes
                            @else
                                No
                            @endif
