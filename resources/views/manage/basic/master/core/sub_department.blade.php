<div class="card">
    <div class="card-header align-items-center d-flex p-2">
        <ol class="breadcrumb m-0 flex-grow-1">
            ...
            <li class="breadcrumb-item active">SubDepartment</li>
        </ol>
                ...
                @foreach ($sub_department_list as $sub_department)
                    <tr>
                        ...
                        <td class="text-center">
                            <!-- Effective Date -->
                            @if ($sub_department->effective_date)
                                {{ date('d-m-Y', strtotime($sub_department->effective_date)) }}
                            @else
                                N/A
                            @endif
                        </td>
                        <td>
                            @if ($sub_department->is_active == 1)
                                Yes
                            @else
                                No
                            @endif
