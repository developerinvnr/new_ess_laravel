<div class="row">
    <!-- Salary Card -->
    <div class="col">
        <a href="{{route('salary')}}" class="card ad-info-card- text-decoration-none">
            <div class="card-body align-items-center text-center border-bottom-d cutm-top-menu">
    ...
    <!-- Eligibility Card -->
    <div class="col">
        <a href="{{route('eligibility')}}" class="card ad-info-card- text-decoration-none">
            <div class="card-body align-items-center text-center border-bottom-d cutm-top-menu">
                <div class="icon-info-text-n d-flex align-items-center justify-content-center">
    ...
    <!-- CTC Card -->
    <div class="col">
        <a href="{{route('ctc')}}" class="card ad-info-card- text-decoration-none">
            <div class="card-body align-items-center text-center border-bottom-d cutm-top-menu">
                <div class="icon-info-text-n d-flex align-items-center justify-content-center">
    ...
    <!-- Annual Salary Card -->
    <div class="col">
        <a href="{{route('annualsalary')}}" class="card ad-info-card- text-decoration-none">
            <div class="card-body align-items-center text-center border-bottom-d cutm-top-menu">
                <div class="icon-info-text-n d-flex align-items-center justify-content-center">
    ...
    <div class="col">
        <a href="{{route('investment')}}" class="card ad-info-card- text-decoration-none">
            <div class="card-body align-items-center text-center border-bottom-d cutm-top-menu">
                <div class="icon-info-text-n d-flex align-items-center justify-content-center">
