										...
										<div class="mfh-machine-profile">
                                            <div style="margin-top:-40px;float:left;margin-left:660px;">
												<ul class="kra-btns nav nav-tabs border-0" id="myTab1" role="tablist">
													...
													<li class="mt-1"><a class="active" id="Promotion-tab20" style="font-size: 15px;"
											...
											<div class="tab-content splash-content2" id="myTabContent2">
												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 tab-pane fade active show"
                                                    ...
                                                    <div class="card">
														...
														<table class="table table-pad" id="employeetablemang" style="border-collapse: collapse; width: 100%;">
															<thead>
																	<tr>
                                                                                    ...
                                                                                    @foreach($employeedetails->Available_Designations as $designation)
                                                                                        <option value="{{ $designation->id }}"
                                                                                            ...
                                                                                            @if(
                                                                                                ...
                                                                                                || (empty($employeedetails->HOD_Designation) && $designation->designation_name == $employeedetails->Reviewer_Designation)
                                                                                            ) selected @endif>
																			...
																			<td>
                                                                                <select style="width:50px;" class="grade-select" disabled>
                                                                                    <option value="">Select Grade</option>
                                                                                        ...
                                                                                        @if($employeedetails->Current_Grade == ($employeedetails->HOD_Grade ? $employeedetails->HOD_Grade : $employeedetails->Reviewer_Grade)) selected @endif>
                                                                                        {{ $employeedetails->Current_Grade }}
                                                                                    </option>

                                                                                    <!-- Loop through the Next Grades -->
                                                                                    @foreach($employeedetails->Next_Grade_Array as $index => $nextGrade)
                                                                                        <option value="{{ $employeedetails->Next_Id[$index] }}"
                                                                                            ...
                                                                                            @if($nextGrade == ($employeedetails->HOD_Grade ? $employeedetails->HOD_Grade : $employeedetails->Reviewer_Grade)) selected @endif>
                                                                                            {{ $nextGrade }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
