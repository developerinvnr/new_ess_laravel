...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.showPayslipDetails = function (payslipId) {
        ...
        if (selectedPayslip) {
            ...
            document.getElementById("basicRow").style.display = "none";
            document.getElementById("hraRow").style.display = "none";
            document.getElementById("bonusRow").style.display = "none";
            document.getElementById("specialAllowanceRow").style.display = "none";
            document.getElementById("conveyanceRow").style.display = "none";
            document.getElementById("transportRow").style.display = "none";
            document.getElementById("daRow").style.display = "none";
            document.getElementById("leaveEncashRow").style.display = "none";
            document.getElementById("arrearsRow").style.display = "none";
            document.getElementById("incentiveRow").style.display = "none";
            document.getElementById("variableAdjustmentRow").style.display = "none";
            document.getElementById("performancePayRow").style.display = "none";
            document.getElementById("npsRow").style.display = "none";
            document.getElementById("noticePayRow").style.display = "none";
            document.getElementById("performanceIncentiveRow").style.display = "none";
            document.getElementById("cityCompensatoryAllowanceRow").style.display = "none";
            document.getElementById("relocationAllowanceRow").style.display = "none";
            document.getElementById("variableReimbursementRow").style.display = "none";
            document.getElementById("carAllowanceRow").style.display = "none";
            document.getElementById("arrearCarAllowanceRow").style.display = "none";
            document.getElementById("arrearBasicRow").style.display = "none";
            document.getElementById("arrearHraRow").style.display = "none";
            document.getElementById("arrearSpecialAllowanceRow").style.display = "none";
            document.getElementById("arrearConveyanceRow").style.display = "none";
            document.getElementById("arrearBonusRow").style.display = "none";
            document.getElementById("bonusAdjustmentRow").style.display = "none";
            document.getElementById("arrearLtaReimbursementRow").style.display = "none";
            document.getElementById("arrearRelocationAllowanceRow").style.display = "none";
            document.getElementById("arrearPerformancePayRow").style.display = "none";
            document.getElementById("arrearLvEncashRow").style.display = "none";
...
// Function to hide all payslip sections
function hidePayslipSections() {
    const sections = [
        "basicEarnings", "hra", "bonus", "specialAllowance", "conveyanceAllowance", "transportAllowance", 
        "da", "leaveEncash", "arrears", "incentive", "variableAdjustment", "performancePay", "nps", 
        "noticePay", "performanceIncentive", "cityCompensatoryAllowance", "relocationAllowance", 
        "variableReimbursement", "carAllowance", "arrearCarAllowance", "arrearBasic", "arrearHra", 
        "arrearSpecialAllowance", "arrearConveyance", "arrearBonus", "bonusAdjustment", 
        "arrearLtaReimbursement", "arrearRelocationAllowance", "arrearPerformancePay", "arrearLvEncash", 
        "tds", "esic", "npsContribution", "arrearPf", "arrearEsic", "voluntaryContribution", 
        "deductionAdjustment", "recoveryConveyanceAllowance", "relocationAllowanceRecovery", 
        "recoverySpecialAllowance", "providentFund"
    ];
