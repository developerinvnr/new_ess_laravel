...
@include('employee.sidebar')
                            ...
                            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                                <div class="card chart-card ">
                                    <div class="card-header" id="attendance">
                                        <h4 class="text-center">Investment Declaration Form {{$investmentDeclaration->Period ?? ''}}</h4>
                                    </div>
                                    <div class="card-body" style="padding-top:0px;">
                                        <div class="mfh-machine-profile">
                                                    <div style="float:left;width:300px;">
                                                    <div class="float-start me-3 mt-2">
                                                            <input type="radio" name="Regime" class="me-2 float-start" style="margin-top:-5px;" onclick="showTab('oldregime')"  @if(isset($investmentDeclaration->Regime) && $investmentDeclaration->Regime =='old' ) checked @endif> Old Regime
                                                        </div>
                                                        <div class="float-start me-3 mt-2">
                                                            <input type="radio" name="Regime" class="me-2 float-start" style="margin-top:-5px;" onclick="showTab('newregime')"  @if(isset($investmentDeclaration->Regime) && $investmentDeclaration->Regime =='new' ) checked @endif> New Regime
                                                        </div>
                                            ...
                                            <div class="tab-content splash-content2 mt-3" id="myTabContent2">
                                                <!-- <div class="regim-panel tab-pane fade active table-responsive show" id="oldregime" role="tabpanel"> -->
                                                <div 
                                                        id="oldregime" 
                                                        role="tabpanel"
                                                        @class([
                                    ...
                                    <div class="card-body" style="padding-top:0px;">
                                        ...
                                        <!-- Display "Old Regime" Title -->
                                                    ...
                                                    <form id="investment-form-submission" method="POST"
                                                        ...
                                                        <input type="hidden" name="selected_regime" id="selected-regime"
                                                            value="{{$investmentDeclaration->Regime ?? ''}}">
                                                        <input type="hidden" name="period_sub" id="period_sub" value="{{$investmentDeclaration->Period??''}}">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <input name="PostOff" id="post_off_edit"
                                                       ...
                                                       @else
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input name="PostOff" id="PostOff_edit"
                                                                            type="number" readonly
                                                                            value="{{ optional($investmentDeclarationsubb)->ULIP ?? '' }}" readonly
                                                                            >
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <input name="PostOff" id="post_off_edit" name="ulip"
                                                                            type="number"  readonly
                                                                            value="{{ optional($investmentDeclarationsubb)->ULIP ?? '' }}" 
                                                                            >
                                                                    </td>
                                                        ...
                                                        <div class="col-md-12 mt-4 mb-3">
                                                            <div class="float-start">
                                                                <label for="date"><b>Date:</b></label>
                                                                <input type="date" id="date" name="date" 
                                                                    value="{{ isset($investmentDeclarationsubb->SubmittedDate) ? $investmentDeclarationsubb->SubmittedDate : now()->format('Y-m-d') }}"><br><br>
    ...
    // Restore the buttons after printing
    if (editButtonsub) editButtonsub.style.display = '';
    if (submitButtonsub) submitButtonsub.style.display = '';
    if (saveButtonsub) saveButtonsub.style.display = '';
});
            ...
            //     // Temporarily hide the buttons
            //     if (editButtonsub) editButtonsub.style.display = 'none';
            //     if (saveButtonsub) submitButtonsub.style.display = 'none';
            //     if (submitButtonsub) saveButtonsub.style.display = 'none';
