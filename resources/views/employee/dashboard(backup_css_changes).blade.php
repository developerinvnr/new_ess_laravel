                                ...
                                @php
                                    ...
                                    @endphp
                                        ...
                                        <li><b class="blink" style="color:red;">Ledger 2024-25</b>
                                            ...
                                            <a style="float: right;" href="{{route('downloadLedger')}}"> 
                                                <i class="fas fa-download ms-2 text-muted" style="cursor: pointer;"></i> 
                                            </a>
                                                    ...
                                                    @foreach($employeeQueryData as $query)
                                                        <div class="query-req-section mb-3">
                                                            <div class="float-start w-100 pb-2 mb-2" style="border-bottom:1px solid #ddd;">
                                                                <span class="float-start"><b>Department: {{ $query->DepartmentName }}</b></span>
                                                            </div>
                                                            <div class="mb-0">
                                                                <p><b>Subject:</b> {{ $query->SubjectName }}</p>
                                                            </div>
                        ...
                        <div class="card ad-info-card-">
                            ...
                            <div class="card-body" style="height: 535px; overflow-y: scroll; overflow-x: hidden;">
                                @foreach($job_opening['regular_job'] as $index => $job)
                                                                <div class="card p-2 mb-3 current-opening">
                                                                    <div>
 ...
 <!-- missiing leadger -->
    ...
    <div class="modal fade" id="ledgerMissingModal" tabindex="-1" aria-labelledby="ledgerMissingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title" id="ledgerMissingModalLabel">Ledger 2024-25</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
               <div id="pdfViewer" style="position: relative; width: 100%; height: 600px;" oncontextmenu="return false;">
                <iframe
                    src="/pdf/faq.pdf#toolbar=0&navpanes=0&scrollbar=0"
                    width="100%"
                    height="100%"
                    style="border: none;"
                ...
                <!-- Transparent overlay for blocking selection/copy, but not scroll -->
                <div style="
                    position: absolute;
                    top: 0;
                    left: 0;
