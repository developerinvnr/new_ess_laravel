                                                ...
                                                @endphp
                                                    ...
                                                    @foreach($data['leaveBalances'] as $index => $balance)
                                                        ...
                                                        <td>{{ $serialNumber++ }}</td> <!-- Display serial number and increment -->
                                                            ...
                                                            <td>{{ $balance->EC }}</td>
                                                            <td><b><span class="use">{{ $balance->OpeningCL }}</span>/<span class="bal">{{ $balance->BalanceCL }}</span></b></td>
                                                            <td><b><span class="use">{{ $balance->OpeningPL }}</span>/<span class="bal">{{ $balance->BalancePL }}</span></b></td>
                                                            <td><b><span class="use">{{ $balance->OpeningSL }}</span>/<span class="bal">{{ $balance->BalanceSL }}</span></b></td>
                                                            <td><b><span class="use">{{ $balance->OpeningEL }}</span>/<span class="bal">{{ $balance->BalanceEL }}</span></b></td>
                                                            <td><b><span class="use">{{ $balance->OpeningOL }}</span>/<span class="bal">{{ $balance->BalanceOL }}</span></b></td>
                                                        </tr>
                                                    @endforeach
                                                    @endforeach
