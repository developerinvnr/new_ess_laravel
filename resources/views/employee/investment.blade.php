...
<div id="loader" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                                    ...
                                    <div class="card-header" >
                                            <h4 class="text-center"><b>Investment Declaration Form - {{$investmentDeclaration->Period}}</b></h4>
                                        </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><b>{{$LTA}}</b>
                                                                                    <input id="lta-checkbox" name="lta_checkbox"
                                                                                        ...
                                                                                        type="checkbox"
                                                                                        @if(isset($investmentDeclaration->LTA) && $investmentDeclaration->LTA > 0 ) checked @endif
    ...
    <tbody>
        ...
        <tr>
            <td>Children - Tuition Fees restricted to max. of 2 children</td>
            <td>
                        ...
                        <div class="tab-pane fade" id="investmentsubmission" role="tabpanel">
                            ...
                            <div id="messageContainer" style="display: none;">
                                ...
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                                    <div class="card chart-card ">
                                        <div class="card-header" >
                                            <h4 class="text-center">Investment Declaration Form</h4>
                                        </div>
                                        <div class="card-body" style="padding-top:0px;">
                                            <div class="mfh-machine-profile">
                                            <ul class="nav nav-tabs" id="myTab1" role="tablist">
