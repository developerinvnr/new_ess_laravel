...
<body class="mini-sidebar">
                                        ...
                                        <tbody>
                                            @foreach ($attendanceData as $data)
                                                @if (!empty($data['leaveApplications']))
                                                    <!-- Only display if leaveApplications is not empty -->
                                                            ...
                                                            @if ($leave->direct_reporting)
                                                                <td>
                                                                    ...
                                                                    @if (in_array($leave->LeaveStatus, [0, 4]))
                                                                        ...
                                                                        <button
                                                                            class="mb-0 sm-btn mr-1 effect-btn btn btn-success accept-btn"
                                                                    ...
                                                                    @elseif($leave->LeaveStatus == 1)
                                                                        <a href="#"
                                                                            class="mb-0 sm-btn mr-1 effect-btn btn btn-warning accept-btn"
                                                                    ...
                                                                    @elseif($leave->LeaveStatus == 2)
                                                                        <a href="#"
                                                                            class="mb-0 sm-btn effect-btn btn btn-success reject-btn"
                                                                            style="padding: 4px 10px; font-size: 10px; pointer-events: none; opacity: 0.6;"
                                ...
                                <div class="float-end form-group s-opt">
                                    @if (Auth::user()->MoveRep == 'Y')
                                        @php
                                            ...
                                            $rpt = DB::select(
                                                "SELECT r.EmployeeID FROM hrm_employee_reporting r 
                                   ...
                                   AND (r.AppraiserId = ? OR r.ReviewerId = ? OR r.HodId = ?)",
                                      ...
                                      // Debugging, you can remove this later
                                            ...
                                            $svs = DB::select('SELECT * FROM hrm_employee WHERE EmployeeID = ?', [
                                                Auth::user()->EmployeeID,
                                            ]);
                                            $resv = $svs[0];
                                        ...
                                        @if ($resv->MoveRep == 'Y')
                                            <h5>
                                                <a href="https://www.vnress.in/Employee/RepIndxHome.php?ID={{ $EId }}&eet={{ $eet }}"
                                                    target="_blank" style="color:blue">Other Team Group</a>
                                            </h5>
                                        @endif
                                    @endif
                                                ...
                                                @foreach ($employeeE as $employee)
                                                    <tr>
                                                        ...
                                                        <td style="text-align:left;">
                                                            {{ ($employee->Fname ?? 'N/A') . ' ' . ($employee->Sname ?? 'N/A') . ' ' . ($employee->Lname ?? 'N/A') }}
                                                        </td>
                                                        ...
                                                        <!-- Designation -->
                                                        <td style="text-align:left;">
                                                            {{ $employee->designation_name ?? 'N/A' }}</td>
                                                        ...
                                                        <td><a href="javascript:void(0);"
                                                                ...
                                                                style="color: #007bff; text-decoration: underline; cursor: pointer;"><i
                                                                    class="fas fa-eye"></i>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)"
                                                                onclick="fetchEligibilityData({{ $employee->EmployeeID }})"
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)"
                                                                onclick="fetchCtcData({{ $employee->EmployeeID }})"
                                                                style="color: #007bff; text-decoration: underline; cursor: pointer;">
                                                                <i class="fas fa-eye"></i>
                                                                <!-- Font Awesome Eye Icon -->
                                                            </a>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="mfh-machine-profile">
                            <ul class="nav nav-tabs" id="myTab1" role="tablist"
                                ...
                                <li class="nav-item">
                                    <a style="color: #0e0e0e;" class="nav-link active" id="myteam"
                                        data-bs-toggle="tab" href="#MyteamTab" role="tab"
                                        aria-controls="MyteamTab" aria-selected="false">My team</a>
                                </li>
                                <li class="nav-item d-none">
                                    <a style="color: #0e0e0e;" class="nav-link" id="attendance" data-bs-toggle="tab"
                                        href="#AttendanceTab" role="tab" aria-controls="AttendanceTab"
    ...
    <div class="modal show" id="leaveHistory" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form id="attendance-form" method="POST" action="">
                        ...
                        <div class="form-group" id="reportRemarkInGroup" style="display: none;">
                            ...
                            <textarea name="reportRemarkIn" class="form-control" id="reportRemarkInReq" placeholder="Enter your remarks"
    ...
    <div class="modal fade" id="eligibilitydetails" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card chart-card">
                                ...
                                <div class="card-body align-items-center">
                                    <ul class="eligibility-list">
                                        <li>City Category A: <span class="p-0">/-</span><span
                                                id="lodgingA"></span><span><i class="fas fa-rupee-sign"></i></span>
                                        </li>
                                        <li>City Category B: <span class="p-0">/-</span><span
                                                id="lodgingB"></span><span><i class="fas fa-rupee-sign"></i></span>
                                        </li>
                                        <li>City Category C: <span class="p-0">/-</span><span
                                                id="lodgingC"></span><span><i class="fas fa-rupee-sign"></i></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card chart-card">
                                ...
                                <div class="card-body">
                                    <ul class="eligibility-list">
                                        <li><strong>Health Insurance:</strong><span id="health_ins"></span><span><i
                                                    class="fas fa-rupee-sign"></i></span></li>

                                        <li><strong>Group Term Life Insurance:</strong><span
                                                id="group_term"></span><span><i class="fas fa-rupee-sign"></i></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card chart-card">
                                ...
                                <div class="card-body">
                                    <ul class="eligibility-list">
                                        ...
                                        <li id="classoutside"><strong>Mode/Class outside HQ:</strong> <span
                            ...
                            <div class="card chart-card">
                                ...
                                <div class="card-body align-items-center">
                                    <ul class="eligibility-list">
                                        <li id="daHqsection">DA@HQ: <span id="daHq"></span> <span>/- Per
                                                Day</span></li>
    ...
    <!-- Modal ctc-->
    <div class="modal fade" id="ctcModal" data-bs-backdrop="static" tabindex="-1"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="card-body dd-flex align-items-center">
                                    <ul class="ctc-section" id="annual-components">
                                        <li>
                                            ...
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="LTA_Value">12,000</b></div>
                                        </li>
                                        <li>
                                            <div class="ctc-title">Children Education Allowance</div>
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="ChildEduAllowance_Value">2,400</b></div>
                                        </li>
                                        <li>
                                ...
                                <div class="card-body dd-flex align-items-center">
                                    <ul class="ctc-section" id="other-annual-components">
                                        <li>
                                            ...
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="Gratuity_Value">50,000</b></div>
                                        </li>
                                        <li>
                                            <div class="ctc-title">Employer's PF Contribution</div>
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="EmployerPF_Value">5,000</b></div>
                                        </li>
                                        <li>
                                            <div class="ctc-title">Mediclaim Policy Premiums</div>
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="MediclaimPolicy_Value">3,000</b></div>
                                        </li>
                                        <li>
                                            <div class="ctc-title">Fixed CTC</div>
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="FixedCTC_Value">720,000</b></div>
                                        </li>
                                        <li>
                                            <div class="ctc-title">Performance Pay</div>
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="PerformancePay_Value">25,000</b></div>
                                        </li>
                                        <li>
                                ...
                                <div class="card-body dd-flex align-items-center">
                                    <ul class="ctc-section" id="additional-benefit">
                                        <li>
                                            ...
                                            <div class="ctc-value"><i class="fas fa-rupee-sign"></i> <b
                                                    class="ml-2" id="InsurancePremium_Value">3,000</b></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script>
                ...
                success: function(response) {
                    ...
                    if (response.team && response.team.length > 0) {
                        response.team.forEach(function(member) {
                            ...
                            teamMembers += '<li class="dropdown-item"><a href="' + profileUrl + '">' +
                                member.Fname + ' ' + member.Sname + ' ' + member.Lname + '</a></li>';
                        });
                    } else {
                    ...
                    dropdown.css({
                        top: tdPosition.top + 25 +
                        'px', // Position the dropdown 25px below the menu icon
            ...
            fetch(`/employee-eligibility/${employee_id}`)
                ...
                .then(data => {
                    ...
                    function updateTwheeler(value) {
                        ...
                        if (value && value !== "0" && value !== "0.00" && value !== "" && value !== "NA") {
                            const pContent = twheelerElement.querySelector('p') ? twheelerElement.querySelector('p')
                                .innerText : ''; // Preserve the <p> content
                            twheelerElement.innerHTML =
                            `<p>${value} /Km (Approval based for official use)</p>`; // Append the new value
                    ...
                    function updatefourwheeler(value) {
                        ...
                        if (value && value !== "0" && value !== "0.00" && value !== "" && value !== "NA") {
                            const pContent = fourwheeler.querySelector('p') ? fourwheeler.querySelector('p').innerText :
                                ''; // Preserve the <p> content
                            fourwheeler.innerHTML =
                            `<p>${value} /Km (Approval based for official use)</p>`; // Append the new value
                    ...
                    if (data.Mobile_Hand_Elig === "N") {
                        ...
                        document.getElementById('handset').innerText = (data.Mobile_Hand_Elig === "Y") ? "Eligible" :
                            "Not Eligible";
                    }
                    // Open the modal
        ...
        document.getElementById('sendButtonReq').addEventListener('click', function() {
            ...
            .value; // Get employee ID from hidden input
            const repo_employeeId = {{ Auth::user()->EmployeeID }};
        ...
        $(document).ready(function() {
            $('#sendButtonleave').on('click', function(event) {
                ...
                .text(), // Use .text() for displaying values instead of .val() for inputs
