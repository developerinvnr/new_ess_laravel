...
<body class="mini-sidebar">
										...
										<tbody>
											@foreach(Auth::user()->employeeAssetReq as $index => $request)
												<tr>
													...
													<td>{{ $assetName ?? '-' }}</td> <!-- Display AssetName -->
													<!--<td>-->
    ...
    <th colspan="2" style="text-align: center;">Details</th> <!-- Asset Details and Asset History -->
...
<tr>
    ...
    <th style="text-align: center;">Asset History</th>
</tr>
																				...
																				@endif
																					...
																					<td>
																						...
																						<button type="button" class="mb-0 sm-btn mr-1 effect-btn btn btn-success accept-btn" data-bs-toggle="modal"
																							...
																							@if(($request->AccPayStatus === 0 && Auth::user()->EmployeeID == $request->AccId) || 
																								($request->ITApprovalStatus === 0 && Auth::user()->EmployeeID == $request->ITId) || 
																								($request->HODApprovalStatus === 0 && Auth::user()->EmployeeID == $request->HodId))
																								Action
																							@else
																								Action
																							@endif
																					...
																					<td>
																					@if(
																						($request->AccPayStatus === 0 && Auth::user()->EmployeeID == $request->AccId) || 
																						($request->ITApprovalStatus === 0 && Auth::user()->EmployeeID == $request->ITId) || 
																						($request->HODApprovalStatus === 0 && Auth::user()->EmployeeID == $request->HodId)
																					)
																						<button type="button" class="mb-0 sm-btn mr-1 effect-btn btn btn-success accept-btn" data-bs-toggle="modal"
																					...
																					@else
																						<button type="button" class="mb-0 sm-btn mr-1 effect-btn btn btn-success accept-btn" disabled>
																							Action
																						</button>
																					@endif
																				</td>
																	...
																	<div class="card-body">
																		...
																		<form id="assetRequestFormVehcile" method="POST" enctype="multipart/form-data">
																			...
																			<div class="row">
																				...
																				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
																					<div class="form-group">
																						<label for="model_name" class="col-form-label"><b>Model Name </label>
																											...
																											<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
																												...
																												<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
																													<div class="form-group">
																														...
																														<textarea class="form-control" id="remarksnew" name="remarksnew" rows="4" maxlength="50" placeholder="Enter any remarks"></textarea>
																														<div class="invalid-feedback">Remarks are optional.</div>
																													</div>
																												</div>
													...
													<tbody>
														@foreach(Auth::user()->employeeAssetvehcileReq as $index => $request)
															<tr>
																...
																<td>{{ $request->current_odo_meter ?? '-' }}</td>
																<td>{{ $request->odo_meter ?? '-' }}</td>
...
<div class="modal-dialog modal-md modal-dialog-centered" role="document">
   <div class="modal-content">
	  <div class="modal-header">
		 <h5 class="modal-title" id="viewqueryModalLabelofficial">Official Assets Details</h5>
		 <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
		 <span aria-hidden="true">×</span>
		 </button>
	  </div>
...
aria-hidden="true">
		...
		<div class="modal-body">
			<div class="row assets-details-popup">
				...
				<div class="col-md-6 bill-show mb-2">
					<ul class="p-0 ml-3">
					<li><b>Bill Copy</b><a href="" id="asstBillCopy"><i class="fas fa-file-pdf"></i> </a></li>
					<li style="display: none"><b>DL Copy</b><a href="./images/excel-invoice.jpg"><i class="fas fa-file-image"></i> </a></li>
					<li style="display: none">><b>Vehicle Photo</b><a href="./images/excel-invoice.jpg"><i class="fas fa-file-image"></i> </a></li>
					<li style="display: none">><b>DL Copy</b><a href="./images/excel-invoice.jpg"><i class="fas fa-file-image"></i> </a></li>
					</ul>
				</div>
				<div class="col-md-6 bill-show mb-2">
					<ul class="p-0 ml-3">
					<li><b>Assets Copy</b><a href="" id="asstAssetsCopy"><i class="fas fa-file-image"></i> </a></li>
					
					<li style="display: none">><b>RC Copy</b><a href="./images/excel-invoice.jpg"><i class="fas fa-file-image"></i> </a></li>
					<li style="display: none">><b>Insurance Copy</b><a href=""><i class="fas fa-file-pdf"></i>  </a></li>
					</ul>
				</div>
				<div class="col-md-12">
					<b>Remarks:</b>
				...
				<div class="col-md-12" id="HODFeild" style="display: none">
					<div class="query-req-section">
						...
						<div class="mb-2"><p>Remarks: <span id="HODApprovalRemarks">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna</span></p></div>
				...
				<div class="col-md-12" id="ITFeild" style="display: none">
					<div class="query-req-section">
						...
						<div class="mb-2"><p>Remarks: <span id="ITApprovalRemarks">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna</span></p></div>
						<div class="w-100" style="font-size:11px;">
				...
				<div class="col-md-12" id="AccPayFeild" style="display: none">
					<div class="query-req-section">
						...
						<div class="mb-2"><p>Remarks: <span id="AccPayRemarks">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna</span></p></div>
						<div class="w-100" style="font-size:11px;">
	...
	<div id="viewassetsHistoryModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="viewassetsHistoryModalLabel"  data-bs-backdrop="static" data-bs-keyboard="false"
	aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="viewqueryModalLabelhistory">Assets History Details -</h5>
				<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">×</span>
				</button>
			</div>
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                $('#asstPurchaseDate').text(data.PurchaseDate || '-');
                ...
                $('#asstRegistrationDate').text(data.RegistrationDate || '-');
                $('#asstOwnership').text(data.Owenship || '-');
                ...
                $("#HODApprovalDate").text(data.HODSubDate || '-');
                $("#ITApprovalStatus").text(getStatusMeaning(data.ITApprovalStatus) || '-');
                $("#ITApprovalRemarks").text(data.ITRemark || '-');
                $("#ITApprovalDate").text(data.ITSubDate || '-');
                $("#AccPayStatus").text(getStatusMeaning(data.AccPayStatus) || '-');
                $("#AccPayRemarks").text(data.AccRemark || '-');
                $("#AccPayDate").text(data.AccSubDate || '-');
                data.HODApprovalStatus > 0 && data.HODSubDate != '' && data.HODSubDate != null ? $('#HODFeild').show() : $('#HODFeild').hide();
                data.ITApprovalStatus > 0 && data.ITSubDate != '' && data.ITSubDate != null ? $('#ITFeild').show() : $('#ITFeild').hide();
                data.AccPayStatus > 0 && data.AccSubDate != '' && data.AccSubDate != null ? $('#AccPayFeild').show() : $('#AccPayFeild').hide();
            } else {
