...
<body class="mini-sidebar">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($seperationData as $separation)
                                                                        @foreach($separation['seperation'] as $data)
                                                                            ...
                                                                            : 'Not specified' 
                                                                                                            ...
                                                                                                            <td>{{ $data->Emp_Reason ?? 'Not specified' }}</td>
                                                                                                            <!-- Separation Reason -->
                                                                                                            <td><a data-bs-toggle="modal" data-bs-target="#empdetails" href="">Click</a>
                                                                                                            </td>
                                                                                                            <td></td>
                                                                                                            <td></td>
                                                                                                        </tr>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center">No separation data available for any
                                                    employee.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    @foreach($approvedEmployees as $data)
                                                            ...
                                                            : 'Not specified' 
                                                                                            ...
                                                                                            <td>
                                                                                                <a href="#" data-bs-toggle="modal"
                                                                                                    data-bs-target="#clearnsdetailsLOGISTIC"
                                                                                                    data-emp-name="{{ $data->Fname }} {{ $data->Lname }} {{ $data->Sname }}"
                                                                                                    data-designation="{{ $data->DesigName }}"
                                                                                                    data-emp-code="{{ $data->EmpCode }}"
                                                                                                    data-department="{{ $data->DepartmentName }}"
                    ...
                    <form id="departmentnocfrom" method="POST">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="DDH_Amt"
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="TID_Amt"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="APTC_Amt"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="HOAS_Amt"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
    ...
    <div class="modal fade show" id="clearnsdetailsLOGISTIC" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle3">Departmental NOC Clearance Form (Logistic)
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                    ...
                    <form id="logisticsnocform">
                        ...
                        <h5 style="border-bottom: 1px solid #ddd; margin-bottom: 10px;">
                            ...
                            <div class="clformbox">
                                ...
                                <div class="clreremarksbox">
                                    <input class="form-control" type="text" name="otherremark"
                                        placeholder="if any remarks enter here">
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="itnocform">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="sim_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="handset_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="laptop_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="camera_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="datacard_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="email_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
                        ...
                        <div class="clformbox">
                            ...
                            <div class="clrecoveramt">
                                <input class="form-control" type="text" name="mobile_recovery_amount"
                                    placeholder="Enter recovery amount">
                            </div>
                            <div class="clreremarksbox">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="clformbox">
                            <div class="formlabel" style="width:40%;">
                                <input style="width:100%;" class="form-control mb-2" type="text"
                                    placeholder="Enter your parties name"><br>
                                <input type="radio" name="docdata"><label>NA</label>
                                <input type="radio" name="docdata"><label>Yes</label>
                                <input type="radio" name="docdata"><label>No</label>
                            </div>
