...
class ProfileController extends Controller
{
    public function profile()
    {
        ...
        $employeeData = \DB::table('hrm_employee_general')
            ...
            ->select(
                'hrm_employee_general.DateJoining',
                'core_city_village_by_state.city_village_name',
                'hrm_employee_general.DepartmentId',
                'hrm_employee_general.TerrId',
                'hrm_employee_general.ZoneId',
                'hrm_employee_general.RegionId',
        ...
        $separationRecord = \DB::table('hrm_employee_separation')
            ...
            ->first();
        if ($separationRecord) {
            return view('seperation.profile', compact(
                'employeeData',
                'territoryData',
                'designationName',
                'employeeDataDuration',
                'finalResult',
                'functionName',
                'years',
                'experience',
